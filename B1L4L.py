...
Y8888P' Y888888P Y88888P YP   YP Y88888P {BLUE}GOD {WHITE}                                                                                                                                                                             
   \33[37;41m\t[ᥫ᭡] DEVELOPED BY BILAL AHMED (BILAL)\33[0;m
{GREEN}[ᥫ᭡] AUTHOR     : BILAL AHMED
{GREEN}[ᥫ᭡] FACEBOOK   : FLOWER輪
{GREEN}[ᥫ᭡] GITHUB     : BILAL787750

{WHITE}================================================
   \33[37;41m\t ONE AND ONLY GOD ALLAH\33[0;m
{WHITE}=================================================""")
def linex():
    print('\033[1;37m----------------------------------------------')
def clear():
